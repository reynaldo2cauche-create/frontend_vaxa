...
Usuario edita nombre
    ↓
1️⃣ GUARDAR (PUT /api/certificados/[id]/editar-nombre)
   └─ Guarda "_nombre_override" en BD
    ↓
2️⃣ REGENERAR (POST /api/certificados/[id]/regenerar)
   └─ Lee "_nombre_override" de BD
   └─ Genera nuevo PDF con el nombre editado
    ↓
3️⃣ ACTUALIZAR UI
   └─ Muestra el nuevo nombre
   └─ Marca "Nombre personalizado"
